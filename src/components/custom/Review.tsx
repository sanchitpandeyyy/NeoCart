...
const Review = () => {
  ...
  return (
    <div className="">
      <h3 className="text-xl  mb-2 font-semibold">Write a Review</h3>
      <div className="mt-4">
      ...
      <div className="border rounded-lg p-4 mt-5 shadow-md">
        <h3 className="text-xl mt-4 mb-2 font-semibold">Customer Reviews</h3>
